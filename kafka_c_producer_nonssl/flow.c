/*-----------------------------------------------------------------------------
    ...
    Date of generation: 11/02/2019 11:52:11
    Flow details:
...
void flow()
{
        ...
        if((jpid = ns_kafka_init_producer("10.10.30.55", 9092, "Amol", "", "", 100, "error_msg")) < 0)
        {
        ...
        if((ret = ns_kakfa_close_connection(jcid, "KAFKAProducerClose" ,error_msg)) < 0 )
        {
