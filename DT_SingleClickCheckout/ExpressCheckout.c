...
void ExpressCheckout()
{
   ...
   ns_add_cookie_val_ex("Access_Token", NULL, NULL, AccessTbuff1);
	...
	ns_start_transaction("COM_Exp_CheckOut");
    ns_start_transaction("DT_API_EC_draftorder_OPTIONS");
    ns_web_url("DT_API_EC_draftorder1",
    ...
    ns_end_transaction("DT_API_EC_draftorder_OPTIONS",NS_AUTO_STATUS);

   // ns_web_add_auto_header("customerVidForPerfTestOrder", "false", 0);
    ns_start_transaction("DT_API_EC_draftorder_POST");
    ...
    ns_end_transaction("DT_API_EC_draftorder_POST", NS_AUTO_STATUS);

    ns_start_transaction("DT_API_EC_OriginReview_OPTIONS");
    ns_web_url ("DT_API_EC_OriginReview1",
    ...
    ns_end_transaction("DT_API_EC_OriginReview_OPTIONS", NS_AUTO_STATUS);

    ns_start_transaction("DT_API_EC_OriginReview_GET");
    ns_web_url ("DT_API_EC_OriginReview",
        //"URL=https://order-api.jcpenney.com/order-api/v1/accounts/L112986139863/draft-order?expand=status%2Cdelivery%2Cbilling&origin=review",
        "URL=https://order-api.jcpenney.com/order-api/v1/accounts/{CustomerIdSP}/draft-order?expand=status%2Cdelivery%2Cbilling&origin=review",
    ...
    ns_end_transaction("DT_API_EC_OriginReview_GET", NS_AUTO_STATUS);

    ns_start_transaction("DT_API_EC_BestCoupon_OPTIONS");
    ns_web_url ("DT_API_EC_BestCoupon1",
    ...
    ns_end_transaction("DT_API_EC_BestCoupon_OPTIONS", NS_AUTO_STATUS);

    ns_start_transaction("DT_API_EC_BestCoupon_GET");
    ns_web_url ("DT_API_EC_BestCoupon",
        "URL=https://order-api.jcpenney.com/order-api/v2/best-coupon?expand=pricing",
        "HEADER=Authorization:Bearer {AccessTokenSP}",
        "HEADER=X-Client-Id:Basic amNwOnlvZGF3Ojc1NTU4NTk2",
        "HEADER=content-type:application/json;charset=utf-8",
    ...
    ns_end_transaction("DT_API_EC_BestCoupon_GET", NS_AUTO_STATUS);
    ns_end_transaction("COM_Exp_CheckOut",NS_AUTO_STATUS);
    ns_page_think_time(0);
    	 
    	 if(Exituser <= 87){
    	 ns_start_transaction("COM_AbandonmentAtExpSinglePageCheckout");
         ns_end_transaction("COM_AbandonmentAtExpSinglePageCheckout", NS_AUTO_STATUS);

//   ns_start_transaction("DT_API_AB_bagitems_POST");
//    ns_web_url ("DT_API_AB_bagitems",
//        //"URL=https://services.loadtest1a.dp-dev.jcpcloud2.net/order-api/v1/accounts/0jLjjh5hrAX13BPNxjTl/draft-order/bag/items",
//        "URL=https://services.loadtest1a.dp-dev.jcpcloud2.net/order-api/v1/accounts/{CustomerIdSP}/draft-order/bag/items",
//        "METHOD=DELETE",
//        "HEADER=Authorization:Bearer {AccessTokenSP}",
//        "HEADER=content-type:application/json;charset=utf-8",
//        "HEADER=Accept-Language:en-us",
...
//    ns_end_transaction("DT_API_AB_bagitems_POST", NS_AUTO_STATUS);
	...
	ns_start_transaction("TotalSubmitOrder");
     ...
     ns_start_transaction("COM_Exp_SubmitOrder");
	ns_start_transaction("DT_API_EC_PO_DraftOrder_OPTIONS");
     ns_web_url("DT_API_EC_PO_DraftOrder1",
        "URL=https://order-api.jcpenney.com/order-api/v1/accounts/{CustomerIdSP}/draft-order",
        "METHOD=OPTIONS",
        "HEADER=Access-Control-Request-Method:POST",
    ...
    ns_end_transaction("DT_API_EC_PO_DraftOrder_OPTIONS",NS_AUTO_STATUS);
    
    ns_start_transaction("DT_API_EC_PO_DraftOrder_POST");
    ns_web_url ("DT_API_EC_PO_DraftOrder",
        //"URL=https://order-api.jcpenney.com/order-api/v1/accounts/L112986139863/draft-order",
        "URL=https://order-api.jcpenney.com/order-api/v1/accounts/{CustomerIdSP}/draft-order",
        "METHOD=POST",
        "HEADER=Authorization:Bearer {AccessTokenSP}",
    ...
    ns_end_transaction("DT_API_EC_PO_DraftOrder_POST", NS_AUTO_STATUS);
    ...
    ns_web_url ("EC_OrderConfirmation",
        ...
        "URL=https://www.jcpenney.com/checkout/oc?OrderId={OrderConfID}&scc=true",
...
//********************************************************************************//  
    ...
    ns_start_transaction("DT_API_EC_orders_OPTIONS");
    ns_web_url("DT_API_EC_orders_opt",
        "URL=https://order-api.jcpenney.com/order-api/v1/orders/{OrderConfID}",
        "METHOD=OPTIONS",
        "HEADER=Access-Control-Request-Method:GET",
        "HEADER=Access-Control-Request-Headers:authorization, content-type",
        "HEADER=Accept-Language:en-us",
    ...
    ns_end_transaction("DT_API_EC_orders_OPTIONS",NS_AUTO_STATUS);
    
    ns_start_transaction("DT_API_EC_orders_GET");
    ns_web_url ("DT_API_EC_orders",
    ...
    ns_end_transaction("DT_API_EC_orders_GET",NS_AUTO_STATUS);
    SkipOrderConfirmation:
    ns_end_transaction("COM_Exp_SubmitOrder",NS_AUTO_STATUS);
    ns_end_transaction("Dotcom_SubmitOrder",NS_AUTO_STATUS);
    ns_end_transaction("TotalSubmitOrder",NS_AUTO_STATUS);

	ns_start_transaction("DT_API_EC_PO_ContentAggregator_OPTIONS");
    ns_web_url("DT_API_EC_PO_ContentAggregator1",
    ...
    ns_end_transaction("DT_API_EC_PO_ContentAggregator_OPTIONS",NS_AUTO_STATUS);

    ns_start_transaction("DT_API_EC_PO_ContentAggregator_GET");
    ns_web_url ("DT_API_EC_PO_ContentAggregator",
        "URL=https://content-api.jcpenney.com/content-aggregator/shared-components/zones/SiteWidePromo/checkout/oc",
    ...
    ns_end_transaction("DT_API_EC_PO_ContentAggregator_GET", NS_AUTO_STATUS);
