...
void SaveForLater()
{
    ...
    ns_start_transaction("COM_SB_SaveForLater");
    ns_start_transaction("DT_API_SFL_bagitems_OPTIONS");
    ...
    ns_end_transaction("DT_API_SFL_bagitems_OPTIONS", NS_AUTO_STATUS);
    
    ns_start_transaction("DT_API_SFL_bagitems_DELETE");
    ...
    ns_end_transaction("DT_API_SFL_bagitems_DELETE", NS_AUTO_STATUS);

    ns_start_transaction("DT_API_savedForLater_OPTIONS");
    ...
    ns_end_transaction("DT_API_savedForLater_OPTIONS", NS_AUTO_STATUS);

    ns_start_transaction("DT_API_savedForLater_GET");
    ...
    ns_end_transaction("DT_API_savedForLater_GET", NS_AUTO_STATUS);

    ns_start_transaction("DT_API_SFL_draftorder_OPTIONS");
    ...
    ns_end_transaction("DT_API_SFL_draftorder_OPTIONS", NS_AUTO_STATUS);

    ns_start_transaction("DT_API_SFL_draftorder_GET");
    ...
    ns_end_transaction("DT_API_SFL_draftorder_GET", NS_AUTO_STATUS);
    
//    ns_start_transaction("DT_API_SFL_online_GET");
//       ns_web_url("DT_API_SFL_online",
//        "URL=https://www.jcpenney.com/v2/content/pg40072100007/online/S1",
...
//    );
//    ns_end_transaction("DT_API_SFL_online_GET", NS_AUTO_STATUS);
    ns_end_transaction("COM_SB_SaveForLater", NS_AUTO_STATUS);
