...
void SignIn()
{
    ...
    // ***************Sign in *********************
	ns_start_transaction("DT_ExpSignin");
	ns_start_transaction("DT_API_Exp_OauthToken_OPTIONS");
         ns_web_url("DT_API_Exp_OauthToken1",
    ...
    ns_end_transaction("DT_API_Exp_OauthToken_OPTIONS",NS_AUTO_STATUS);
    
    ns_start_transaction("DT_API_Exp_OauthToken_POST");
    ns_web_url ("DT_API_Exp_OauthToken",
        "URL=https://account-api.jcpenney.com/v5/oauth2/token",
        "METHOD=POST",
    ...
    ns_end_transaction("DT_API_Exp_OauthToken_POST", NS_AUTO_STATUS);
    ns_end_transaction("DT_ExpSignin",NS_AUTO_STATUS);
