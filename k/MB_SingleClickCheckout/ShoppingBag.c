...
void ShoppingBag()
{
    ...
    ns_web_url("MB_API_SB_draftorder",
    ...
    ns_start_transaction("MB_API_SB_SavedItems_OPTIONS");
    ns_web_url("MB_API_SB_SavedItem1",
    ...
    ns_end_transaction("MB_API_SB_SavedItems_OPTIONS",NS_AUTO_STATUS);

    ns_start_transaction("MB_API_SB_SavedItems_GET");
    ns_web_url ("MB_API_SB_SavedItem",
        //"URL=https://account-api.jcpenney.com/v5/accounts/L112986139863/saved-items/savedForLater?limit=5",
        "URL=https://account-api.jcpenney.com/v5/accounts/{CustomerIdSP}/saved-items/savedForLater?limit=5",
        "HEADER=Authorization:Bearer {AccessTokenSP}",
        "HEADER=content-type:application/json;charset=utf-8",
    ...
    ns_end_transaction("MB_API_SB_SavedItems_GET", NS_AUTO_STATUS);

/*
   ns_start_transaction("MB_API_SB_RewardProfile_OPTIONS");
    ns_web_url("MB_API_SB_RewardProfile1",
    ...
    ns_end_transaction("MB_API_SB_RewardProfile_OPTIONS",NS_AUTO_STATUS);

    ns_start_transaction("MB_API_SB_RewardProfile_GET");
    ns_web_url ("MB_API_SB_RewardProfile",
        //"URL=https://account-api.jcpenney.com/v5/accounts/L112986139863/rewards-profile?expand=points%2Ccertificates%2Crecentactivity",
        "URL=https://account-api.jcpenney.com/v5/accounts/{CustomerIdSP}/rewards-profile?expand=points%2Ccertificates%2Crecentactivity",
        "HEADER=Authorization:Bearer {AccessTokenSP}",
        "HEADER=content-type:application/json;charset=utf-8",
    ...
    ns_end_transaction("MB_API_SB_RewardProfile_GET", NS_AUTO_STATUS);
*/    
