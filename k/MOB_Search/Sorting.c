...
{  
	...
	if(YodaProductPage != 1){
		...
		ns_start_transaction("MOB_SearchNoSortingAvailable");
		ns_end_transaction("MOB_SearchNoSortingAvailable",NS_AUTO_STATUS);
		goto PDPLabel;
		}
		 int length = 0; 
    ...
    ns_start_transaction("MOB_Search_Sort_OPTIONS");
    ns_web_url ("MB_API_Search_sortBy1",
       //"URL=https://search-api.jcpenney.com/v1/search-service/s?responseType=content&mode=1&productGridView=medium&searchTerm={SearchTermEncFP}&sort={YodaSortOptionSP1}",
       "URL=https://content-api.jcpenney.com/content-aggregator/aggregate-pages/s?searchTerm={SearchTermEncFP}&sort={YodaSortOptionSP1}&mode=1",
       "METHOD=OPTIONS",
    ...
    ns_end_transaction("MOB_Search_Sort_OPTIONS", NS_AUTO_STATUS);    
   
    ns_start_transaction("MOB_Search_Sort");
    ns_web_url ("MB_API_Search_sortBy",
       // "URL=https://search-api.jcpenney.com/v1/search-service/s?responseType=content&mode=1&productGridView=medium&searchTerm={SearchTermEncFP}&sort={YodaSortOptionSP1}",
       "URL=https://content-api.jcpenney.com/content-aggregator/aggregate-pages/s?searchTerm={SearchTermEncFP}&sort={YodaSortOptionSP1}&mode=1",
        "HEADER=Accept-Language:en-US,en;q=0.8",
        INLINE_URLS,
    ...
    ns_end_transaction("MOB_Search_Sort", NS_AUTO_STATUS);
    
    ns_start_transaction("MB_API_Search_sortBy_organic_OPTIONS");
    ns_web_url ("MB_API_Search_sortBy_organic1",
        "URL=https://search-api.jcpenney.com/v1/search-service/s?productGridView=medium&mode=1&searchTerm={SearchTermEncFP}&sort={YodaSortOptionSP1}&responseType=organic",
        "METHOD=OPTIONS",
        "HEADER=Access-Control-Request-Method:GET",
        "HEADER=Accept-Language:en-US,en;q=0.8",
        INLINE_URLS,
    ...
    ns_end_transaction("MB_API_Search_sortBy_organic_OPTIONS", NS_AUTO_STATUS);
        
    ns_start_transaction("MB_API_Search_sortBy_organic_GET");
    	ns_web_url ("MB_API_Search_sortBy_organic",
        "URL=https://search-api.jcpenney.com/v1/search-service/s?productGridView=medium&mode=1&searchTerm={SearchTermEncFP}&sort={YodaSortOptionSP1}&responseType=organic",
        "HEADER=Accept-Language:en-US,en;q=0.8",
        INLINE_URLS,
            "URL=http://www88.jcpenney.com/cm?tid=1&ci=90024642&vn2=e4.0&st=1467032499374&vn1=4.16.9&ec=utf-8&pi=Search%20Results&cg=Mobile%7CSearch%20Results&se=shirts&sr=960&rnd=1467034518576&pv_a11=1&pv_a12=newarrivals&pv_a23=Google%20Chrome&pv_a38=responsive&ul=http%3A%2F%2Fm.jcpenney.com%2Fgallery%2Fsearch%3FNtt%3Dshirts%26N%3D510%26searchType%3DPredictive%2520Search", "HEADER=Accept-Language:en-US,en;q=0.8", "COOKIE=BNSOrigin;BNSPrevPercentage;mmcore.tst;CoreID6;TestSess3;90024642_login;marketing;TLTSID;_ga;_gat;DPUserTracking;DPSessionTimeOutInterval;recentSearchData;clientTestPool1;DPJSESSIONID;90024642_reset;DPInstance;DPLastAccessedTime;DPCluster;DPIdentifier;DPRRSESSIONID;DP_USER_AUTH_STATUS;DP_SFL_PPIDS;DP_USER_FAVCOUNT;fsr.s;mmapi.store.p.0;mmapi.store.s.0", END_INLINE,
    ...
    ns_end_transaction("MB_API_Search_sortBy_organic_GET", NS_AUTO_STATUS);
    
//    ns_start_transaction("MB_API_Search_sortBy_sitepromo_GET");
//    ns_web_url ("MB_API_Search_sortBy_sitepromo",
...
//            "URL=https://encrypted-tbn3.gstatic.com/favicon?q=tbn:ANd9GcShz7B7_rhGrfhF07xSC37yJZhCbH-HOdhQ7xN7beQvcWLHXIi9EUwVrhKOGOM", "HEADER=Accept-Language:en-US,en;q=0.8", END_INLINE
//    );
//    ns_end_transaction("MB_API_Search_sortBy_sitepromo_GET", NS_AUTO_STATUS);
