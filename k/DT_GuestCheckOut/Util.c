...
static void get_YodaGuestOrderdetail()
{
   ...
   for(i=0; i<YodaODLoopCount; i++)
     ...
     ns_save_data_eval("/home/netstorm/work/data/JCPenney/OrderDetail/Dotcom_GuestOrderDetail.txt", NS_APPEND_FILE, OrderDetail);
}
