   ...
   ns_save_string(dest_buf, "YodaProductUrlDP");	
    ...
    // Check to see if any product is available after sort/Filter....
     if(!strcmp(ns_eval_string("{YodaProductUrlSP}"),"")){  
     	ns_start_transaction("COM_SearchPDPNoProductFound");
		ns_end_transaction("COM_SearchPDPNoProductFound",NS_AUTO_STATUS);    
    	ns_exit_session();
     }
     
    ns_start_transaction("COM_Search_ProductDetailPage");
    ns_web_url ("DT_API_Search_products",
    ...
    ns_end_transaction("COM_Search_ProductDetailPage", NS_AUTO_STATUS);
    ...
    else
    {
     ...
     ns_end_transaction("COM_PDP_SSR", NS_AUTO_STATUS);
  	...
  	ProductAggregator:
   ns_start_transaction("DT_API_Search_RegionProductAggregator_GET");  
   ns_web_url("DT_API_Search_ProductAggregartor",
	...
	ns_end_transaction("DT_API_Search_RegionProductAggregator_GET", NS_AUTO_STATUS);
 	
 	FreeShippingContent:
    

    ns_start_transaction("DT_API_Search_PDP_sharedcomponents_OPTIONS");  
   ns_web_url("DT_API_Search_PDP_sharedcomponents1",
	...
	ns_end_transaction("DT_API_Search_PDP_sharedcomponents_OPTIONS", NS_AUTO_STATUS); 
	   	    	 
   ns_start_transaction("DT_API_Search_PDP_sharedcomponents_GET");  
   ns_web_url("DT_API_Search_PDP_freeshippingcontent",
        //"URL=https://content-api.jcpenney.com/content-aggregator/shared-components/zones/s1/pdp?pTmplType=&ppid=pp5006480540",
        "URL=https://content-api.jcpenney.com/content-aggregator/shared-components/zones/s1{ProductDetailSP}",
        "HEADER=Accept-Language:en-us,en;q=0.5"
    );
	ns_end_transaction("DT_API_Search_PDP_sharedcomponents_GET", NS_AUTO_STATUS);
                     
       if(!strcmp(ns_eval_string("{WebIdSP}"),"")){      //Condition to Check ProductOfferingSP if available
       ns_start_transaction("COM_Search_NoWebIdAvailable");
       ns_end_transaction("COM_Search_NoWebIdAvailable", NS_AUTO_STATUS);
      // ns_exit_session();
      goto NextRequest;
    }
       
    	ns_start_transaction("DT_API_Search_productspecifications_OPTIONS");
      ns_web_url ("DT_API_Search_specifications1",
	...
	ns_end_transaction("DT_API_Search_productspecifications_OPTIONS", NS_AUTO_STATUS);

   
    ns_start_transaction("DT_API_Search_productspecifications_GET");
    ns_web_url ("DT_API_Search_productspecifications",
        "URL=https://browse-api.jcpenney.com/v3/product-specifications/{WebIdSP}",
        "HEADER=Accept-Language:en-US,en;q=0.8",
        INLINE_URLS,
            "URL=http://m.jcpenney.com/b/assets/img/unavailable-color.png", "HEADER=Accept-Language:en-US,en;q=0.8", "COOKIE=BNSOrigin;BNSPrevPercentage;mmcore.tst;cmTPSet;marketing;TLTSID;CavSID;_ga;_gat;DPUserTracking;DPSessionTimeOutInterval;recentSearchData;clientTestPool1;DPJSESSIONID;DPInstance;DPLastAccessedTime;DPCluster;DPIdentifier;DPRRSESSIONID;DP_USER_AUTH_STATUS;DP_SFL_PPIDS;DP_USER_FAVCOUNT;akaau;CavSF;CavLTS;CavPI;mmapi.store.p.0;mmapi.store.s.0;fsr.s;_IFR_jcpenney.com_fsr.a", END_INLINE,
    ...
    ns_end_transaction("DT_API_Search_productspecifications_GET", NS_AUTO_STATUS);
    
    NextRequest:
    
   	ns_start_transaction("DT_API_Search_BreadCrumb_GET");
     ns_web_url ("DT_API_Search_BreadCrumb",
        //"URL=https://search-api.jcpenney.com/v1/j/breadcrumb?ppId=ppr5007607907&type=product&productGridView=medium&searchTerm=shirts&urlState=product_size%3D10%2Bhusky",
	...
	ns_end_transaction("DT_API_Search_BreadCrumb_GET", NS_AUTO_STATUS);
    
    ns_start_transaction("DT_API_Search_ProductAggregator_OPTIONS");
    ns_web_url ("DT_API_Search_inventory1",
	...
	ns_end_transaction("DT_API_Search_ProductAggregator_OPTIONS", NS_AUTO_STATUS);
 
    
    ns_start_transaction("DT_API_Search_ProductAggregator_GET");
    ns_web_url ("DT_API_Search_inventory",
        "URL=https://browse-api.jcpenney.com/v2/product-aggregator/{YodaProductIdSP}/additional-details?deliveryAvailabilityCheckRequired=false",
        "HEADER=Accept-Language:en-US,en;q=0.8",
        INLINE_URLS,
    ...
    ns_end_transaction("DT_API_Search_ProductAggregator_GET", NS_AUTO_STATUS);
   
    
//    ns_start_transaction("DT_Search_PDP_ProductSummaries_GET");
//    ns_web_url ("DT_API_Search_root",
//        "URL=https://browse-api.jcpenney.com/browse-aggregator/v1/product-summaries-aggregator?ppId={RRPricePPIDFP}",
//        "HEADER=Accept-Language:en-US,en;q=0.8",
//    );
//	ns_end_transaction("DT_Search_PDP_ProductSummaries_GET", NS_AUTO_STATUS);

	ns_start_transaction("DT_API_Search_PDP_SiteWidePromo_OPTIONS");
    ns_web_url ("DT_API_Search_PDP_SiteWidePromo1",
	...
	ns_end_transaction("DT_API_Search_PDP_SiteWidePromo_OPTIONS", NS_AUTO_STATUS);
			
    ns_start_transaction("DT_API_Search_PDP_SiteWidePromo_GET");
    ns_web_url ("DT_API_Search_PDP_SiteWidePromo",
         //"URL=https://content-api.jcpenney.com/content-aggregator/shared-components/zones/SiteWidePromo/p/bulwark-flame-resistant-long-sleeve-henley-tee-big-tall/pp5006480540",
        "URL=https://content-api.jcpenney.com/content-aggregator/shared-components/zones/SiteWidePromo{ProductDetailSP}",
        "HEADER=Accept-Language:en-us,en;q=0.5"
    );
	ns_end_transaction("DT_API_Search_PDP_SiteWidePromo_GET", NS_AUTO_STATUS);
	
	ns_start_transaction("DT_API_Search_urgency_GET");
    ns_web_url ("DT_API_Search_urgency",
    ...
    ns_end_transaction("DT_API_Search_urgency_GET", NS_AUTO_STATUS);
    
//     if(!strcmp(ns_eval_string("{ProductOfferingSP}"),"")){      //Condition to Check ProductOfferingSP if available
//       ns_start_transaction("COM_Search_NoProductOfferingAvailable");
//       ns_end_transaction("COM_Search_NoProductOfferingAvailable", NS_AUTO_STATUS);
...
//    
   ...
   if (SKUAvailable < 1)
    {
    	//printf("\n----------------------NoOfferingAvailable--------------------\n");
    	ns_start_transaction("COM_Search_NoSkuOfferingAvailable");
       	ns_end_transaction("COM_Search_NoSkuOfferingAvailable", NS_AUTO_STATUS);
       	goto SkipNextRequest;
    }  
   ...
   //printf("\n*********SKUOfferingDP=[[[%s]]]**********\n",ns_eval_string("{SKUOfferingDP}"));
	...
	ns_start_transaction("DT_API_Search_SKUOffering_OPTIONS");
	...
	ns_end_transaction("DT_API_Search_SKUOffering_OPTIONS", NS_AUTO_STATUS);
	
	//ns_web_add_header("jcp_version", "GREEN", 0);
	ns_start_transaction("DT_API_Search_SKUOffering_GET");
	...
	ns_end_transaction("DT_API_Search_SKUOffering_GET", NS_AUTO_STATUS);
